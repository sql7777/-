...
import SendDataToDestinationBLServer
...
e = EmbeddedCom.ComCOMThread(Port='/dev/ttyS1', baudrate=115200, timeout=0.1, RCallarg=rfidcallbackdata,
...
senderbluetooth = SendDataToDestinationBLServer.SendDataToDestinationBLServer(name="FireFly-3288C",port=6)
