        ...
        if len(data) >= 3:
            ...
            if b'NUMS' == nums:
                ...
                if getnums <= 0:
                    ...
                    #print(data)
                    #testret=redisconnpool.rpush('queue:UsedEPCSendQueue',data)
                    savestr=''
                    for vdata in data:
                        #print(type(vdata))
                    ...
                    if redisconnpool != None:
                        pass
                        testret=redisconnpool.rpush('queue:UsedEPCSendQueue',usavestr)
                    else:
                        print('rpush err')
#                    for vdata in data:
#                        if b'EPC:' in vdata:
        ...
        if issysset == 0:
            ...
            if GetSysIsStart()==True:
                ...
                if isfirstrunbluetoothflg==0:
                    SetSysBluetoothCMD(5)#SetSysBluetoothCMD(2)
